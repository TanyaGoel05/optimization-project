...
var resizePizzas = function(size) {
  // Use strict mode to make the code more secure
  "use strict";
 ...
 // EDIT-1: Used document.getElementsByClassName() instead of using
 // document.querySelectorAll() since Web API call is faster.
...
// EDITED: Moved pizzasDiv to outside the for loop to avoid calling the dom repeatedly
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // Initialize the variable "elem" outside the for-loop
  // to prevent it is being created everytime the loop goes through
  var elem;
  // Changed "querySelector" to "getElementById" since Web API call is faster,
  // and initialize the variable and store the reference outside the loop
